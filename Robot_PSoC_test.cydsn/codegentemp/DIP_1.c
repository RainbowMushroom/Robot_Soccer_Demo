...
{
    uint8 staticBits = (DIP_1_DR & (uint8)(~DIP_1_MASK));
    DIP_1_DR = staticBits | ((uint8)(value << DIP_1_SHIFT) & DIP_1_MASK);
}
...
{
	CyPins_SetPinDriveMode(DIP_1_0, mode);
}
...
{
    return (DIP_1_PS & DIP_1_MASK) >> DIP_1_SHIFT;
}
...
{
    return (DIP_1_DR & DIP_1_MASK) >> DIP_1_SHIFT;
}


/* If interrupt is connected for this Pins component */ 
#if defined(DIP_1_INTSTAT) 
    ...
    *******************************************************************************/
    ...
    {
		if((position & DIP_1_0_INTR) != 0u) 
		{ 
			 DIP_1_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *******************************************************************************/
    ...
    {
        return (DIP_1_INTSTAT & DIP_1_MASK) >> DIP_1_SHIFT;
    }
